...
public class BankApplication {
	...
	public static void main(String[] args) {
		...
		case 1:		InputReader consoleReader = new ConsoleReader();
					consoleReader.readInput();
					break;
		case 2:		InputReader fileReader = new FileReader();
					fileReader.readInput();
					break;
		case 3:		InputReader propertyReader = new PropertyFileReader();
